    ...
    <div>
      ...
      >
        <a
          ...
          class="new-namespace-panel gl-border gl-flex gl-w-full gl-shrink-0 gl-flex-col gl-items-center gl-rounded-base gl-px-3 gl-py-6 hover:!gl-no-underline lg:gl-flex-row"
