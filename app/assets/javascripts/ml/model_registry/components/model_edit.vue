  ...
  <div>
    ...
    <gl-form>
      ...
      <div class="gl-flex gl-gap-3">
        <gl-button data-testid="primary-button" variant="confirm" type="submit" @click="edit"
          >{{ $options.i18n.actionPrimaryText }}
        </gl-button>
        <gl-button data-testid="secondary-button" variant="default" type="reset" :href="modelPath"
