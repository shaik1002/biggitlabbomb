...
<template>
  <gl-link
    ...
    :title="fileName"
    target="_blank"
    class="file-tree-includes-link gl-flex gl-justify-between gl-rounded-base gl-px-3 gl-py-2 gl-text-default hover:gl-bg-gray-50 hover:gl-text-default hover:gl-no-underline"
  >
