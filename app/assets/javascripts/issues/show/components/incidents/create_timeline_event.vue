...
<template>
  <div class="create-timeline-event gl-relative gl-flex gl-items-start">
    <div
      ...
      class="gl-border gl-z-1 gl-mt-2 gl-flex gl-h-8 gl-w-8 gl-shrink-0 gl-items-center gl-justify-center gl-self-start gl-rounded-full gl-bg-white gl-p-3 gl-text-gray-200"
    >
