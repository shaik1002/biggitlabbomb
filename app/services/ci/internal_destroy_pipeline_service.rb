...
module Ci
  # Use `DestroyPipelineService` to destroy pipelines at user's request.
  # This service must be used from internal systems that don't depend on user interactions.
