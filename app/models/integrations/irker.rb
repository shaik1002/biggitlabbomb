...
module Integrations
  class Irker < Integration
    ...
    field :default_irc_uri,
      ...
      description: -> { _('URI to add before each recipient. The default value is `irc://irc.network.net:6697/`.') },
    ...
    field :recipients,
      ...
      description: -> { _('Comma-separated list of channels or email addresses.') },
      required: true,
      help: -> do
