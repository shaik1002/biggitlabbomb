...
module QA
  module Resource
    class Project < Base
      ...
      def change_ci_pipeline_variables_minimum_override_role(new_role)
        ...
        raise(
          ...
          "Could not change ci_pipeline_variables_minimum_override_role to #{new_role}. " \
            "Request returned (#{response.code}): `#{response}`."
        )
      end
