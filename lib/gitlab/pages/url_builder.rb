...
module Gitlab
  module Pages
    class UrlBuilder
      ...
      def hostname
        return custom_domain if custom_domain
        return instance_pages_domain if namespace_in_path?
        return project_path if is_namespace_homepage?
        return instance_pages_domain unless subdomain.present?

        instance_pages_domain.prepend("#{subdomain}.")
      end
      ...
      def custom_domain
        @custom_domain ||= project.default_custom_pages_domain
      end
