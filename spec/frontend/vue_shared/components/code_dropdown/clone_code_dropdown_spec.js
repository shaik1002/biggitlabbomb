...
import KerberosCodeDropdownItem from 'ee_component/vue_shared/components/code_dropdown/kerberos_code_dropdown_item.vue';
...
describe('CloneCodeDropdown', () => {
  ...
  const findCopyKRB5UrlButton = () => wrapper.findComponent(KerberosCodeDropdownItem);
