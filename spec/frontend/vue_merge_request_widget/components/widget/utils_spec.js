...
describe('generateText', () => {
  it.each`
    ...
    ${'%{danger_start}Hello world%{danger_end}'}                               | ${'<span class="gl-font-bold gl-text-danger">Hello world</span>'}
    ...
    ${'%{strong_start}%{danger_start}Hello world%{danger_end}%{strong_end}'}   | ${'<span class="gl-font-bold"><span class="gl-font-bold gl-text-danger">Hello world</span></span>'}
