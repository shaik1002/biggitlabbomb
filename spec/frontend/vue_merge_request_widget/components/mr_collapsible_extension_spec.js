...
describe('Merge Request Collapsible Extension', () => {
  ...
  describe('while loading', () => {
    ...
    it('renders the buttons disabled', () => {
      expect(wrapper.findAll('button').at(0).attributes('disabled')).toEqual(expect.any(String));
      expect(wrapper.findAll('button').at(1).attributes('disabled')).toEqual(expect.any(String));
    });
