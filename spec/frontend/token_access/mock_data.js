...
export const jobTokenPoliciesByCategory = [
  {
    value: 'CONTAINERS',
    text: 'Containers',
    policies: [
      { value: 'READ_CONTAINERS', text: 'Read' },
      { value: 'ADMIN_CONTAINERS', text: 'Read and write' },
    ],
  },
  {
    value: 'DEPLOYMENTS',
    text: 'Deployments',
    policies: [
      { value: 'READ_DEPLOYMENTS', text: 'Read' },
      { value: 'ADMIN_DEPLOYMENTS', text: 'Read and write' },
    ],
  },
];
