...
RSpec.describe Ci::Runner, type: :model, feature_category: :runner do
  ...
  describe '#token' do
    ...
    let(:token_owner_record) do
      create(:ci_runner, runner_type: runner_type, registration_type: registration_type, **attrs)
    end
    ...
    shared_examples 'an encrypted routable token for resource' do |prefix|
      ...
      context 'when :routable_runner_token feature flag is enabled globally' do
        before do
          stub_feature_flags(routable_runner_token: true)
        end
