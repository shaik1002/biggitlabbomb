  ...
  context "multiple projects with merge requests" do
    ...
    describe '#execute' do
      ...
      context 'filter by blob path' do
        ...
        let!(:merge_request) { create(:merge_request, :opened, source_project: project1, target_project: project1, source_branch: 'feature', target_branch: 'master') }
        let!(:merge_request_diff) { create(:merge_request_diff, merge_request: merge_request) }
        let!(:merge_request_diff_file) { create(:merge_request_diff_file, merge_request_diff: merge_request_diff) }
