    ...
    describe '#execute' do
      it 'updates component usage counts' do
        ...
        resources.each do |resource|
          resource.components.each do |component|
            ...
            expect(component.reload.last_30_day_usage_count_updated_at).to eq(Time.current)
          end
        end
      end
      ...
      it 'updates resource usage counts' do
        ...
        resources.each do |resource|
          ...
          expect(resource.reload.last_30_day_usage_count_updated_at).to eq(Time.current)
        end
      end
