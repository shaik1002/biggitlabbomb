...
> - Ability to view IP addresses [introduced](https://gitlab.com/gitlab-org/gitlab/-/issues/428577) in GitLab 17.6 [with a flag](../../administration/feature_flags.md) named `pat_ip`. Disabled by default.
