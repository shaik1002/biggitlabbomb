...
You might get an error that states
`I'm sorry, I've started to hallucinate. Please clarify your question.`.

This error occurs when the model starts hallucinating and GitLab Duo Chat cannot process its response.
Try a different request, or leave feedback to help us improve.
